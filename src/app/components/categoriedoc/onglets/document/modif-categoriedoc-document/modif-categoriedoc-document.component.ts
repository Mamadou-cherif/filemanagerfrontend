...
@Component({
  selector: 'app-modif-categoriedoc-document',
  templateUrl: './modif-categoriedoc-document.component.html',
  styleUrls: ['./modif-categoriedoc-document.component.scss']
})
export class ModifCategoriedocDocumentComponent implements OnInit {
  ...
  sendValues(formValue:NgForm){
    ...
    const documentObj={
      ...
      categoriedocId: this.document.categoriedocId,
      link: newFilename,
    ...
    this.documentService.updateDocument(documentObj)
      ...
      this.router.navigateByUrl("/fileManager/modifCategorieDoc/"+ this.document.categoriedocId)
      },
      error=>{
