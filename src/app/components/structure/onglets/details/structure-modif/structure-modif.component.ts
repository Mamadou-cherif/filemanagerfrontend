...
@Component({
  selector: 'app-structure-modif',
  templateUrl: './structure-modif.component.html',
  styleUrls: ['./structure-modif.component.scss']
})
export class StructureModifComponent implements OnInit {
